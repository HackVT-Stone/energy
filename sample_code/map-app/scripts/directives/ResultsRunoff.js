...
define([
	...
	var module = angular.module('ResultsRunoff',[]);
	module.directive('resultsRunoff', ['ConfigurationService', 'GUIStateService', 'UserStateService',
		function(vtswcalcAppConfiguration, vtswcalcAppGUIState, vtswcalcAppUserState) {
			return {
				...
				transclude: false,
				scope: false,
				templateUrl: '/views/directives/resultsRunoff.html',
				link: {
