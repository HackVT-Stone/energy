...
define([
	...
	var module = angular.module('ResultsCosts',[]);
	module.directive('resultsCosts', ['ConfigurationService', 'GUIStateService', 'UserStateService',
		function(vtswcalcAppConfiguration, vtswcalcAppGUIState, vtswcalcAppUserState) {
			return {
				...
				transclude: true,
				scope: false,
				templateUrl: '/views/directives/resultsCosts.html',
				link: {
